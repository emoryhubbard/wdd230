...
function onClick(e) {
    ...
    lastClick = clickBox.classList[0]; //change of code
    doUpdates();
}
function drawBoard() {
...
function setSquare() {
      ...
      fadeSquareIn(); //code change
}
function fadeSquareIn() {
    const clickBox = document.querySelector(".div" + lastClick);
    clickBox.classList.remove("fade-in");    //removes old one if present
    clickBox.offsetWidth; //magic retrigger  //to retrigger it
    clickBox.classList.add("fade-in");    
